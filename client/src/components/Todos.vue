     ...
     <div class="container">
        <div class="col-sm-10">
          ...
          <table class="table table-dark table-striped table-hover">
            ...
            <tbody>
              <tr v-for="(todo, add_tasks) in todos" :key="add_tasks">
        ...
        <b-modal ref="updateToModal"
          ...
          <b-button-group>
              <b-button value="submit" variant="primary">Обновить</b-button>
              <b-button value="reset" variant="danger">Сброс</b-button>
            </b-button-group>
          </b-form>
        </b-modal>
        <button type="button"
